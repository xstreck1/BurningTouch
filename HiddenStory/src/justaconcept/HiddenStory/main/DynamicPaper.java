...
public class DynamicPaper extends BasicPaper {
	...
	p_.image(clear_paper_.get(mouse_x - RADIUS, mouse_y - RADIUS, RADIUS * 2, RADIUS * 2), mouse_x - RADIUS, mouse_y - RADIUS);
	p_.image(current_mask_.get(mouse_x - RADIUS, mouse_y - RADIUS, RADIUS * 2, RADIUS * 2), mouse_x - RADIUS, mouse_y - RADIUS);
    }
}
